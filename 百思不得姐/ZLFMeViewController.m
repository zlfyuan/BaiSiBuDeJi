...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"我的";
     ...
     UIBarButtonItem *set = [UIBarButtonItem iteminitWithImage:@"friendsRecommentIcon" heightImage:@"friendsRecommentIcon-click" target:self action:@selector(friendsClicked)];
